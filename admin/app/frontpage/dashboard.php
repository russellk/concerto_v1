...
<div class="roundcont">
  ...
  <div class="roundcont_main">
    <div style="float:left; width:75%;">
        <br />
        <p>Concerto is currently at <b>Version <?php echo CONCERTO_VERSION ?></b>.  For more information, <a href="<?php echo ADMIN_URL ?>/pages/show/docs/3">check out the release notes.</a></p>
    </div>
