...
<!--[if IE]>
<script type="text/javascript" src="<?php echo ADMIN_BASE_URL?>video/html5.js"></script>
<script type="text/javascript" src="<?php echo ADMIN_BASE_URL?>video/flowplayer.min.js"></script>
<script type="text/javascript" src="<?php echo ADMIN_BASE_URL?>video/html5-video.js"></script>
<![endif]-->
